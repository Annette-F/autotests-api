...
# Создаем экземпляр класса Fake с использованием Faker для RU-локали и US-локали
fake = Fake(faker=Faker())
# fake_en = Fake(faker=Faker('en_US'))  # для US-локали
# fake_ru = Fake(faker=Faker('ru_RU'))  # для RU-локали
